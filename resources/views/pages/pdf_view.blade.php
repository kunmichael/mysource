		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="box-header with-border">
				  <h3 class="box-title"><b>Data berkas PDF</b></h3>
						...
						<table id="data_file" class="table table-bordered table-hover">
							<thead>
								...
								<tr>
									<td>{{$row->File_name}}</td>
									<td>
										<a href="file_pdf/{{$row->File_ID}}"><i class="fa fa-desktop"></i></a>
										<a href="files/pdf/{{$row->File_name}}"><i class="fa fa-cloud-download"></i></a>
									</td>
								</tr>
								@endforeach	
							</tbody>
